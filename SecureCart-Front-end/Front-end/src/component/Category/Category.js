...
export default function Category() {
  ...
  function getCategory(){
    const api = url+'category/ordercategory/'+ localStorage.getItem('userId')
  ...
  const handleSubmit = () => {
    ...
    axios.post(url+'category', {"categoryName": addCategory,
    "userId":localStorage.getItem('userId')                        
 },
    {
     headers: {
...
const handleDelete = (id) => {
  const api = url+'category/'+ id +'/'+localStorage.getItem('userId')
...
const handleUpdate = () => {
  const api = url+'category/'+ updateId
