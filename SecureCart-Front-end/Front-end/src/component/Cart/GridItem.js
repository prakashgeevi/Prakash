...
const GridItem = ({handleGetCartItem, productImage, productId, productName, quantity, stock, price, totalprice, itemid, cartId }) => {
  ...
  const handleDeleteItem = () => {
    axios.delete(url+'items/'+itemid+'/'+cartId+'/'+ localStorage.getItem('userId')
  ...
  const handleSelectChange = (event) => {
   ...
   axios.put(url+'items/'+itemid,cartData, {
      headers: {
...
<div>
    ...
    <br/>
        <div className="product">
          ...
          <div style={{paddingTop:20}} className="product-price"><b>RM</b> {price}</div>
      ...
      <div style={{paddingTop:20}} className="product-line-price"> <b>RM</b>  {totalprice}</div>
