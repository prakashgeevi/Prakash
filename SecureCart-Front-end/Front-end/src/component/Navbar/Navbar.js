...
function Navbar({ itemCount2 }) {
 ...
 const[country, setCountry] = useState();
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      {localStorage.getItem('roles') === 'admin' ? (
        <>
          <Button className={classes.root} onClick={handleUser} sx={{ color: 'black' }}>
              Users
            </Button>
        </>
      ) : (
  ...
  return (
    <div>
      <Box >
        <AppBar elevation={0} sx={{ background: '#FFEEE3', color: 'black', borderBottom:'1px solid antiqueblack'}} position="fixed">
          <Toolbar>
            <img onClick={handleOpenHome} style={{ height: 80, width: 80, backgroundColor: 'transparent', cursor: 'pointer', display: { xs: 'none', md: 'flex' }, mr: 1 }} src={Shopping} />
            <Typography
              variant="h6"
              noWrap
              component="div"
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' }, color: 'black' }}>
              <Button
                ...
                onClick={handleProduct} sx={{ color: 'black' }}>
              ...
              {localStorage.getItem('roles') === 'seller' ? (
                <>
                  <Button
                    className={classes.root}
                    onClick={handleCategory} sx={{ color: 'black' }}>
...
{localStorage.getItem('roles') === 'admin' ? (
        <>
            <Button className={classes.root} onClick={handleAdminPayments} sx={{ color: 'black' }}>
...
{localStorage.getItem('roles') === 'admin' ? (
        <>
            <Button className={classes.root} onClick={handleAdminOrders} sx={{ color: 'black' }}>
        ...
        ''
              ...
              {localStorage.getItem('roles') !== 'buyer' ? (
                ...
                <Button onClick={handleMyOrders} sx={{ fontFamily: "revert-layer", color: 'black' }}>
                  <Typography fontWeight={700}>My Orders</Typography>
                </Button>
              )}
              
                <Button onClick={handleQuestions} sx={{ fontFamily: "revert-layer", color: 'black' }}>
...
<Avatar src={localStorage.getItem('profile')}>
      ...
      >
        ...
        <DialogTitle>Edit your profile</DialogTitle>
            <EditUser handleUserClose={handleUserClose} />
