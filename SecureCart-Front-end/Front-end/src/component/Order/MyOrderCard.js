      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} style={{ marginBottom: '20px', maxWidth: '80%', marginLeft: '8%' }}>
        ...
        >
          ...
          <Col md={2}>
            ...
            <p style={{paddingLeft:10}} className="text-pebble mb-0 w-100 mb-2 mb-md-0">RM&nbsp;<b>{totalAmount}</b></p>
          </Col>
          <Col md={4}>
            <Typography style={{paddingLeft:10}} sx={{ width: '33%', flexShrink: 0 }}>
            ...
            {item.map(item => (
             ...
             <Row  className="no-gutters mt-3">
                ...
                <Col xs={6} md={6} className="pr-0 pr-md-3">
                  ...
                  <h6 className="text-charcoal text-left mb-0 mb-md-2"><b>Price:</b>&nbsp;RM<b style={{color: 'text.secondary'}}> {item.totalPrice}</b></h6>
                </Col>
                <Col xs={3} md={3} >
