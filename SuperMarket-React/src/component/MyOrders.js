...
function MyOrders(cartCount1) {
 ...
 const[totalAmount1, setTotalAmount1] = useState(0);
  ...
  function orderlist() {
    ...
    axios.get('http://localhost:8080/order/'+ localStorage.getItem('userId')
  ...
  return (
    <div>
      ...
      <CardContent>
          <Typography>
            <p>Thank you for placing an order with <b>QuickBuy</b>. We appreciate your business! Below, you will find the order details for your reference:</p>

          <p>shipper to : {localStorage.getItem('username')}</p>
          <p>Order Date :  {dateTime}</p>
          <p>Please click the down arrow to see your order details</p>
          </Typography>
