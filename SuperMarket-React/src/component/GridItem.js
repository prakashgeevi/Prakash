...
const GridItem = ({handleGetCartItem, productImage, productId, productName, quantity, stock, price, totalprice, itemid, cartId }) => {
  ...
  const handleDeleteItem = () => {
    ...
    axios.delete('http://localhost:8080/items/'+itemid+'/'+cartId+'/'+ localStorage.getItem('userId')
  ...
  const handleSelectChange = (event) => {
   ...
   axios.put('http://localhost:8080/items/'+itemid,cartData, {
      headers: {
  ...
  return (
    <div>
        ...
        {/* <Grid container spacing={2} style={{borderBottom: "1px solid #ffffff"}}>
      <Grid item xs={2}>
          <img src={"data:image/png;base64,"+productImage} style={{border:'1px solid #ddd', borderRadius:'4px', padding:5, width:'200px', objectFit:'cover' }} />  
        </Grid>

         <Grid item xs={6}>
                  <div style={{paddingLeft:30}}>
                <p style={{color:'Highlight'}}><b>{productName} </b></p>
          ...
          <MenuItem value={10}  >{10}</MenuItem>
               ...
               <Grid item xs={2}>
              <strong>Price :</strong> <span style={{color:'Highlight'}}> <strong>&#x20B9; {price}</strong></span>
               </Grid>
               <Grid item xs={2}>
...
<div>
    ...
    <br/>
        <div className="product">
          ...
          <div style={{paddingTop:20}} className="product-price">&#x20B9; {price}</div>
      ...
      <div style={{paddingTop:20}} className="product-line-price"> &#x20B9;  {totalprice}</div>
